...
Modern LLMs operate through agents with tool use. Works like ToolBench \cite{qinetal2023toolllm} evaluate tool learning, but focus on general tool use rather than SE-specific workflows. Our evaluation framework uses a consistent tool environment across all models, enabling fair comparison of tool efficiency.

...
% Numeric citation style is conventional for ASE-J.
...
%% Affiliation [2] confirmed from ubhinus.ac.id. Items below still TODO:
%%  - Go Frendi's institutional affiliation (currently "Independent Researcher")
%%  - Mukhlis's department/faculty (\orgdiv) at UBHINUS
%%  - ORCID for both authors (optional but recommended)
\author[1]{\fnm{Go Frendi} \sur{Gunawan}}\email{gofrendiasgard@gmail.com}
\author*[2]{\fnm{Mukhlis} \sur{Amien}}\email{amien@ubhinus.ac.id}

\affil[1]{\orgname{Independent Researcher}, \country{Indonesia}}
\affil*[2]{\orgdiv{[Department/Faculty TODO]},
  \orgname{Universitas Bhinneka Nusantara (UBHINUS)},
...
%% sn-jnl ships matching .bst files (e.g., sn-mathphys-num.bst).

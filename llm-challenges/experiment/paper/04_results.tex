...
\begin{itemize}
    \item \textbf{Tool count vs score:} Pearson $r=0.077$ (95\% CI $[-0.20, 0.34]$, $p=0.575$, $n=54$) -- no linear correlation; the interval spans zero
    \item \textbf{Spearman rho:} $0.428$ ($p=0.001$) -- a moderate monotonic relationship, indicating that while \emph{more} tools do not linearly improve scores, the rank ordering of tool use and score are weakly associated
